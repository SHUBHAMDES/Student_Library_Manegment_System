package com.Shubham.Student_Library_Manegment_System.modles;
...
public class Transactions {
    ...
    public void setTransactionStatus(com.Shubham.Student_Library_Manegment_System.Enum.TransactionStatus pending)
    {
    }
}